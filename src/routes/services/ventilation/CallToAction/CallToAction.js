          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                <h2>Заказать монтаж вентиляции</h2>
                <div className="col-md-6">
                  <p className="mad_text_style1" style={{color:'#fff'}}>
                    Оставьте заявку на оказание услуг по монтажу вентиляционных систем, заполнив поля со своим именем и адресом электронной почты. Через короткое время специалисты нашего контактного центра свяжутся с Вами.
                  </p>
                </div>
                <div className="col-md-6">
