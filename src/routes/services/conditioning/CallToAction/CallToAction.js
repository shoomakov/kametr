            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="mad_section_container">
                  <h2 className="mad_separator">Заказать монтаж кондиционирования</h2>
                </div>
                <div className="col-md-6">
                  <p className="mad_text_style1" style={{ color: '#fff' }}>
                    Если у Вас возникла необходимость заказать услуги по монтажу систем кондиционирования или вентиляции в Москве, то Вы можете оставить заявку и мы обязательно свяжемся с Вами в ближайшее время.
                  </p>
                </div>
                <div className="col-md-6">
