          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                <h2>Заказать изготовление корпусной мебели</h2>
                <div className="col-md-6">
                  <p className="mad_text_style1" style={{color:'#fff'}}>
                    Вы можете оставить заказ на производство корпусной мебели. Для этого заполните форму заявки, указав свои имя и адрес Email. Наш менеджер свяжется с Вами через короткое время.
                  </p>
                </div>
                <div className="col-md-6">
