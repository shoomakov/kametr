          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                <h2>Заказать остекление</h2>
                <div className="col-md-6">
                  <p className="mad_text_style1" style={{color:'#fff'}}>
                    Заполнив форму, Вы получите запрос от наших менеджеров на Email. Если Вам необходимо остекление, то введите в соответствующие поля свое Имя и Электронную почту.
                  </p>
                </div>
                <div className="col-md-6">
