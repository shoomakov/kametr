          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                <h2>Заявка на электромонтаж</h2>
                <div className="col-md-6">
                  <p className="mad_text_style1" style={{color:'#fff'}}>
                    Интересно наше предложение? Тогда не сомневайтесь и отправьте заявку на электромонтаж! Укажите свое имя и адрес электронной почты, чтобы наши специалисты могли связаться с Вами и определить фронт работ.
                  </p>
                </div>
                <div className="col-md-6">
